...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Máj 03. 20:39
...
--
CREATE DATABASE IF NOT EXISTS `taskmanager` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `taskmanager`;
...
(41, '2024-05-02', '2024-05-30', 'kutyaetetés', 'lacitest', 'etesd meg morzsit');
